...
技能「sherlock-usearch」的轻量辅助脚本：解析同目录 SKILL.md，提供 CLI 入口、触发词匹配、能力速览。
零第三方依赖。
"""
...
def main():
    ...
    ap.add_argument("--csv", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--json", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--list-sites", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--print-found", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--site", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--timeout", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--usernames-file", default=None, help="文档声明的参数")  # F3 补全
    args = ap.parse_args()
    if args.selftest:
        return selftest()
    if args.match:
