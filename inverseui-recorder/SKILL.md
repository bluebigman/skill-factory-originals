...
displayName: 未命名工具
description: Intent-based UI automation that runs locally. Record real workflows, generate reusable scripts, and safely use local cre
version: 1.0.0
...
> Intent-based UI automation that runs locally. Record real workflows, generate reusable scripts, and safely use local cre
