...
if __name__ == "__main__":
    ...
    ap.add_argument("--budget", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--help", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--nodes", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--protocol", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--roles", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--selftest", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--templates", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--validate", default=None, help="文档声明的参数")  # F3 补全
