...
if __name__ == "__main__":
    ...
    ap.add_argument("--retries", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--selftest", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--timeout", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--verbose", default=None, help="文档声明的参数")  # F3 补全
    ap.add_argument("--workers", default=None, help="文档声明的参数")  # F3 补全
    args = ap.parse_args()
    rc = check_env()
    rc2 = check_merkle()
